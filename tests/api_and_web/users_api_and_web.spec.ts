...
test.describe('/users_api_and_web', () => { 

    test('Creates a new user account via WEB and API @API_AND_WEB @BASIC @FULL', async ({ page, request }) => {
    ...
    test('Log in as an existing user via WEB and API @API_AND_WEB @BASIC @FULL', async ({ page, request }) => {
        const randomNumber = faker.finance.creditCardNumber()  
    ...
    test('Log in as an existing user via WEB and API - Wrong password @API_AND_WEB @FULL @NEGATIVE', async ({ page, request }) => {
        const randomNumber = faker.finance.creditCardNumber()  
        await createUserViaApi(request, randomNumber) 
        const body = JSON.parse(fs.readFileSync(`tests/fixtures/testdata-${randomNumber}.json`, "utf8"))
        const user = {
    ...
    test('Log in as an existing user via WEB and API - Invalid e-mail @API_AND_WEB @FULL @NEGATIVE', async ({ page, request }) => {
        const randomNumber = faker.finance.creditCardNumber()  
        await createUserViaApi(request, randomNumber) 
        const body = JSON.parse(fs.readFileSync(`tests/fixtures/testdata-${randomNumber}.json`, "utf8"))
        const user = {
    ...
    test('Retrieve user profile information via WEB and API @API_AND_WEB @BASIC @FULL', async ({ page, request }) => {
        const randomNumber = faker.finance.creditCardNumber()          
        await createUserViaApi(request, randomNumber) 
        await logInUserViaApi(request, randomNumber) 
        await page.goto('app/profile')
    ...
    test('Update user profile information via WEB and API @API_AND_WEB @BASIC @FULL', async ({ page, request }) => {
        const randomNumber = faker.finance.creditCardNumber()          
        await createUserViaApi(request, randomNumber) 
    ...
    test('Update user profile information via WEB and API - Invalid company name @API_AND_WEB @FULL @NEGATIVE', async ({ page, request }) => {
        const randomNumber = faker.finance.creditCardNumber()          
        await createUserViaApi(request, randomNumber) 
        await logInUserViaWeb(page, randomNumber) 
        await page.goto('app/profile')
    ...
    test('Update user profile information via WEB and API - Invalid phone number @API_AND_WEB @FULL @NEGATIVE', async ({ page, request }) => {
        const randomNumber = faker.finance.creditCardNumber()          
        await createUserViaApi(request, randomNumber) 
        await logInUserViaWeb(page, randomNumber) 
        await page.goto('app/profile')
    ...
    test('Change a user\'s password via WEB and API @API_AND_WEB @BASIC @FULL', async ({ page, request }) => {
        const randomNumber = faker.finance.creditCardNumber()          
        await createUserViaApi(request, randomNumber) 
        await logInUserViaWeb(page, randomNumber)  
        const body = JSON.parse(fs.readFileSync(`tests/fixtures/testdata-${randomNumber}.json`, "utf8"))
    ...
    test('Change a user\'s password via WEB and API - Type same password @API_AND_WEB @FULL @NEGATIVE', async ({ page, request }) => {
        const randomNumber = faker.finance.creditCardNumber()          
        await createUserViaApi(request, randomNumber) 
        await logInUserViaWeb(page, randomNumber)  
        const body = JSON.parse(fs.readFileSync(`tests/fixtures/testdata-${randomNumber}.json`, "utf8"))
    ...
    test('Log out a user via WEB and API @API_AND_WEB @BASIC @FULL', async ({ page, request }) => {
        const randomNumber = faker.finance.creditCardNumber()          
        await createUserViaApi(request, randomNumber) 
        await logInUserViaWeb(page, randomNumber) 
    ...
    test('Delete user account via WEB and API @API_AND_WEB @BASIC @FULL', async ({ page, request }) => {
        const randomNumber = faker.finance.creditCardNumber()          
        await createUserViaApi(request, randomNumber) 
        await logInUserViaWeb(page, randomNumber)  
        await page.goto('app/profile')
